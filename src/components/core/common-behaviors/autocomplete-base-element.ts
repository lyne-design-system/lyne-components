...
import { findReferencedElement, isBrowser, isSafari, isValidAttribute, setAttribute } from '../dom';
...
export abstract class SbbAutocompleteBaseElement extends SbbNegativeMixin(
  ...
  @state() protected state: SbbOverlayState = 'closed';
  ...
  protected abort = new ConnectedAbortController(this);
   ...
   */
  protected ariaRoleOnHost = isSafari();
